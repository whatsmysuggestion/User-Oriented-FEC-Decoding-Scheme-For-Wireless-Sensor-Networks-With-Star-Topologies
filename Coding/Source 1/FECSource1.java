...
import java.io.*;
/**
 * Summary description for SOURCE Client
 *
 */
public class FECSource1 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		addComponent(contentPane, jLabel3, 147,38,240,30);
		addComponent(contentPane, jLabel4, 27,410,200,20);
		addComponent(contentPane, jTextField1, 147,71,400,30);
	...
	private void jButton3_actionPerformed(ActionEvent e)
	{
		if (k!=10)
		{
			String msg="Load The File, Complete the FEC Encoding and then Start SFCC-N4 Encoding";
			JOptionPane op=new JOptionPane();
			op.showMessageDialog(op,msg)	;
		}
		else
